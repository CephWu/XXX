...
public class Notepad01 extends JFrame implements ActionListener,DocumentListener
{   //菜单
    ...
    {   editArea.requestFocus();
        ...
        {   int exitChoose=JOptionPane.showConfirmDialog(this,"文件尚未保存，是否保存？","退出提示",JOptionPane.YES_NO_CANCEL_OPTION);
            ...
            {   //boolean isSave=false;
                if(isNewFile)
                {
                    ...
                    File saveFileName=fileChooser.getSelectedFile();  //如何识别合法的后缀名？？？？？？？？
    ...
    {   final JDialog fontDialog=new JDialog(this,"字体设置",false);
        ...
        final JLabel sample=new JLabel("Notepad");
    ...
    {   //新建
        ...
        {   editArea.requestFocus();
            JOptionPane.showMessageDialog(this,"我太菜了，不会做","提示",JOptionPane.WARNING_MESSAGE);
        }//页面设置结束
        //打印
        ...
        {   editArea.requestFocus();
            JOptionPane.showMessageDialog(this,"没啥好帮的","帮助主题",JOptionPane.INFORMATION_MESSAGE);
        }//帮助主题结束
        //关于
    ...
    {   Notepad01 notepad01=new Notepad01();
        notepad01.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//使用 System exit 方法退出应用程序
    }//main函数结束
}